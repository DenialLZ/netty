...
public class Person implements org.apache.thrift.TBase<Person, Person._Fields>, java.io.Serializable, Cloneable, Comparable<Person> {
  ...
  private static final org.apache.thrift.protocol.TField MARRIDE_FIELD_DESC = new org.apache.thrift.protocol.TField("marride", org.apache.thrift.protocol.TType.BOOL, (short)3);
  ...
  public boolean marride; // optional

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    USERNAME((short)1, "username"),
    AGE((short)2, "age"),
    MARRIDE((short)3, "marride");
  ...
  private static final int __MARRIDE_ISSET_ID = 1;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.USERNAME,_Fields.AGE,_Fields.MARRIDE};
  ...
  static {
    ...
    tmpMap.put(_Fields.MARRIDE, new org.apache.thrift.meta_data.FieldMetaData("marride", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public boolean isMarride() {
    return this.marride;
  }

  public Person setMarride(boolean marride) {
    this.marride = marride;
    setMarrideIsSet(true);
    return this;
  }

  public void unsetMarride() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __MARRIDE_ISSET_ID);
  }

  /** Returns true if field marride is set (has been assigned a value) and false otherwise */
  public boolean isSetMarride() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __MARRIDE_ISSET_ID);
  }

  public void setMarrideIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __MARRIDE_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case MARRIDE:
      if (value == null) {
        ...
        setMarride((java.lang.Boolean)value);
      }
      break;
  ...
  public boolean equals(Person that) {
    ...
    boolean this_present_marride = true && this.isSetMarride();
    boolean that_present_marride = true && that.isSetMarride();
    if (this_present_marride || that_present_marride) {
      if (!(this_present_marride && that_present_marride))
        return false;
      if (this.marride != that.marride)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetMarride()) ? 131071 : 524287);
    if (isSetMarride())
      hashCode = hashCode * 8191 + ((marride) ? 131071 : 524287);
  ...
  public int compareTo(Person other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMarride()).compareTo(other.isSetMarride());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMarride()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.marride, other.marride);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class PersonStandardScheme extends org.apache.thrift.scheme.StandardScheme<Person> {
        ...
        switch (schemeField.id) {
          ...
          case 3: // MARRIDE
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.marride = iprot.readBool();
              struct.setMarrideIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Person struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetMarride()) {
        oprot.writeFieldBegin(MARRIDE_FIELD_DESC);
        oprot.writeBool(struct.marride);
        oprot.writeFieldEnd();
      }
