...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.12.0)", date = "2020-08-05")
public class PersonService {

  public interface Iface {

    public Person getPersonByUsername(java.lang.String usernaem) throws DataException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getPersonByUsername(java.lang.String usernaem, org.apache.thrift.async.AsyncMethodCallback<Person> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public Person getPersonByUsername(java.lang.String usernaem) throws DataException, org.apache.thrift.TException
    {
      send_getPersonByUsername(usernaem);
      return recv_getPersonByUsername();
    }

    public void send_getPersonByUsername(java.lang.String usernaem) throws org.apache.thrift.TException
    {
      getPersonByUsername_args args = new getPersonByUsername_args();
      args.setUsernaem(usernaem);
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getPersonByUsername(java.lang.String usernaem, org.apache.thrift.async.AsyncMethodCallback<Person> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getPersonByUsername_call method_call = new getPersonByUsername_call(usernaem, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class getPersonByUsername_call extends org.apache.thrift.async.TAsyncMethodCall<Person> {
      private java.lang.String usernaem;
      public getPersonByUsername_call(java.lang.String usernaem, org.apache.thrift.async.AsyncMethodCallback<Person> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getPersonByUsername<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getPersonByUsername_args> {
      ...
      public getPersonByUsername_result getResult(I iface, getPersonByUsername_args args) throws org.apache.thrift.TException {
        getPersonByUsername_result result = new getPersonByUsername_result();
        try {
          result.success = iface.getPersonByUsername(args.usernaem);
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getPersonByUsername<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getPersonByUsername_args, Person> {
      ...
      public void start(I iface, getPersonByUsername_args args, org.apache.thrift.async.AsyncMethodCallback<Person> resultHandler) throws org.apache.thrift.TException {
        iface.getPersonByUsername(args.usernaem,resultHandler);
      }
    }
  ...
  public static class getPersonByUsername_args implements org.apache.thrift.TBase<getPersonByUsername_args, getPersonByUsername_args._Fields>, java.io.Serializable, Cloneable, Comparable<getPersonByUsername_args>   {
    ...
    private static final org.apache.thrift.protocol.TField USERNAEM_FIELD_DESC = new org.apache.thrift.protocol.TField("usernaem", org.apache.thrift.protocol.TType.STRING, (short)1);
    ...
    public @org.apache.thrift.annotation.Nullable java.lang.String usernaem; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      USERNAEM((short)1, "usernaem");
    ...
    static {
      ...
      tmpMap.put(_Fields.USERNAEM, new org.apache.thrift.meta_data.FieldMetaData("usernaem", org.apache.thrift.TFieldRequirementType.REQUIRED, 
    ...
    public getPersonByUsername_args(getPersonByUsername_args other) {
      if (other.isSetUsernaem()) {
        this.usernaem = other.usernaem;
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public java.lang.String getUsernaem() {
      return this.usernaem;
    }

    public getPersonByUsername_args setUsernaem(@org.apache.thrift.annotation.Nullable java.lang.String usernaem) {
      this.usernaem = usernaem;
      return this;
    }

    public void unsetUsernaem() {
      this.usernaem = null;
    }

    /** Returns true if field usernaem is set (has been assigned a value) and false otherwise */
    public boolean isSetUsernaem() {
      return this.usernaem != null;
    }

    public void setUsernaemIsSet(boolean value) {
      if (!value) {
        this.usernaem = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case USERNAEM:
        if (value == null) {
          ...
          setUsernaem((java.lang.String)value);
        }
        break;
    ...
    public boolean equals(getPersonByUsername_args that) {
      ...
      boolean this_present_usernaem = true && this.isSetUsernaem();
      boolean that_present_usernaem = true && that.isSetUsernaem();
      if (this_present_usernaem || that_present_usernaem) {
        if (!(this_present_usernaem && that_present_usernaem))
          return false;
        if (!this.usernaem.equals(that.usernaem))
          return false;
      }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((isSetUsernaem()) ? 131071 : 524287);
      if (isSetUsernaem())
        hashCode = hashCode * 8191 + usernaem.hashCode();
    ...
    public int compareTo(getPersonByUsername_args other) {
      ...
      lastComparison = java.lang.Boolean.valueOf(isSetUsernaem()).compareTo(other.isSetUsernaem());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetUsernaem()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.usernaem, other.usernaem);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public java.lang.String toString() {
      ...
      sb.append("usernaem:");
      if (this.usernaem == null) {
        sb.append("null");
      } else {
        sb.append(this.usernaem);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    public void validate() throws org.apache.thrift.TException {
      ...
      if (usernaem == null) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'usernaem' was not present! Struct: " + toString());
      }
    ...
    private static class getPersonByUsername_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<getPersonByUsername_args> {
          ...
          switch (schemeField.id) {
            case 1: // USERNAEM
              if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
                struct.usernaem = iprot.readString();
                struct.setUsernaemIsSet(true);
              } else { 
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPersonByUsername_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.usernaem != null) {
          oprot.writeFieldBegin(USERNAEM_FIELD_DESC);
          oprot.writeString(struct.usernaem);
          oprot.writeFieldEnd();
        }
